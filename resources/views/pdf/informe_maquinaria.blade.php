...
<head>
    ...
    <title>Reportes de maquinarias</title>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="table table-striped table">
            ...
            <tr>
                ...
                <td align="center" width="70%" class="text-left text-company" style="vertical-align: top; padding-top: 10px;">
                    @if($reportType == 0)
                        <span style="font-size: 16px;"><strong>Reporte de maquinarias del dia</strong></span>
                    @else
                        <span style="font-size: 16px;"><strong>Reporte de maquinarias por fecha</strong></span>
                    @endif
                    <br>
                    @if($reportType !=0)
                    ...
                    @endif
                    <br>
                    <span style="font-size: 14px;">Usuario: {{$cliente}}</span>
                </td align="center">
            </tr>
        </table>
    </section>
            ...
            <tbody>
                @foreach($data as $item)
                    <tr>
                        ...
                        <td align="center">{{$item->namecliente}}</td>
