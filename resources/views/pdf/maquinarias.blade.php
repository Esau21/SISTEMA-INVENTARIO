...
<body>
    <div class="invoice-box">
                            ...
                            <td class="top-right" style="border: 1px solid #000;">
                                <div class="top-title" style="font-size: 18px; font-weight: bold; text-align: center;">
                                    ...
                                    <div style="margin-top: 5px; text-align: center;">
                                        No. <span class="bordered" style="border: 3px solid #FF0000; padding: 3px;">{{ $maquinariasP->id }}</span>
                                    </div>
                            ...
                            <td style="border:none;">
                                <table>
                                    <tr>
                                        <td>Día:</td>
                                        <td><span>
                                                {{\Carbon\Carbon::parse($maquinariasP->created_at)->format('d')}}</span>
                                        </td>
                                        <td>Mes:</td>
                                        <td><span>{{\Carbon\Carbon::parse($maquinariasP->created_at)->format('m')}}
                                            </span></td>
                                        <td>Año:</td>
                                        <td><span>
                                                {{\Carbon\Carbon::parse($maquinariasP->created_at)->format('Y')}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nombre:</td>
        ...
        <table>
            ...
            <tr class="item">
                <td class="center-text">{{ $maquinariasP->id }}</td>
                <td class="description">
                    {{ $maquinariasP->name }}
                    <span>Modelo:{{$maquinariasP->model}}</span>
                    <span>Año:{{$maquinariasP->year}}</span>
                </td>
                <td class="right-text">${{number_format($maquinariasP->price, 2)}}</td>
        ...
        <table>
            <tr>
                <td rowspan="5" class="bordered" style="width: 50%;">
                    <strong>SON:</strong> ${{ number_format($maquinariasP->total, 2) }}<br><br>
                ...
                <td class="right-text bordered">${{number_format($maquinariasP->price, 2)}}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="right-text bordered">${{number_format($maquinariasP->iva, 2)}}</td>
            </tr>
            <tr>
                <td class="right-text bordered"><strong>VENTA TOTAL</strong></td>
                <td class="right-text bordered"><strong>${{ number_format($maquinariasP->total, 2) }}</strong></td>
            </tr>
        </table>
        <table>
            <tr>
