            ...
            <div class="widget-content">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-3 align-self-center d-flex justify-content-around">
                        ...
                        class="btn btn-outline-dark"><b><i class="fas fa-hourglass-half"></i> Consultar</b></button>
                        @endif

                        @if($total > 0 )
                        <button wire:click.prevent="Print()" type="button"
                        class="btn btn-outline-dark"><b> <i class="fas fa-print"></i> Imprimir</b></button>
                        @endif
                    </div>
                                ...
                                @foreach($sales as $row)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button wire:click.prevent="viewDetails({{$row}})" class="btn btn-block btn-dark btn-sm">
