...
class RolesController extends Component
{
    ...
    public function CreateRole()
    {
        ...
        $messages = [
            ...
            'roleName.min' => 'El nombre del role debe tener al menos 2 cararteres',
            'roleName.unique' => 'El nombre del role tiene que ser unico y este nombre ya existe'
        ];
    ...
    public function Destroy($id)
    {
        ...
        {
            $this->emit('role-error', 'Nose puede eliminar el role por que tiene permisos asociados');
            return;
        }
