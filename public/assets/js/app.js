        ...
        sidebar: function($recentSubmenu) {
            $('.sidebarCollapse').on('click', function (sidebar) {
                sidebar.preventDefault();
                 ...
                 get_CompactSubmenuShow = null; /*document.querySelector('#compact_submenuSidebar');*/
                get_overlay = document.querySelector('.overlay');
                get_mainContainer = document.querySelector('.main-container')
                if ( get_CompactSubmenuShow != null && (get_CompactSubmenuShow.classList.contains('show') || get_CompactSubmenuShow.classList.contains('hide-sub') ) ) {
                    console.log('main1');
        ...
        onSidebarHover: function() {
            ...
            for (var i = 0; i < getMenu.length; i++) {
                getMenu[i].addEventListener('mouseenter', function() {
                    ...
                    getElementActiveClass = document.querySelector('menu > .show');
                    get_mainContainer = document.querySelector('.main-container')
